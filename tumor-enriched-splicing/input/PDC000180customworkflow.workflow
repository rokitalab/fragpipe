# Workflow: PDC000180customworkflow
...
ionquant.peptidefdr=5
ionquant.proteinfdr=5
...
phi-report.filter=--sequential --picked --psm 0.05 --pep 0.05 --prot 0.05
