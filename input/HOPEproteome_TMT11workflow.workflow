# Workflow: HOPEproteome_TMT11workflow
...
ionquant.peptidefdr=10
ionquant.proteinfdr=10
...
msfragger.search_enzyme_cut_2=KR
...
percolator.cmd-opts=--only-psms --no-terminate --post-processing-tdc --testFDR 0.1 --trainFDR 0.1
percolator.keep-tsv-files=false
percolator.min-prob=0.5
percolator.run-percolator=true
phi-report.dont-use-prot-proph-file=false
phi-report.filter=--sequential --picked --psm 0.1 --pep 0.1 --prot 0.1
